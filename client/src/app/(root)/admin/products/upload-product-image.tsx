...
interface UploadProductImage {
  setfileUrl: UseFormSetValue<AddProductSchemaType>;
}

const UploadProductImage: FC<UploadProductImage> = ({ setfileUrl }) => {
  ...
  const handleUpload = async (selectedFile: File) => {
    ...
    try {
      ...
      setfileUrl("productImage", response.result.url);
    } catch (error) {
  ...
  const handleRemoveFile = () => {
    setFile(null);
    setfileUrl("productImage", ""); // Clear form field
  };
